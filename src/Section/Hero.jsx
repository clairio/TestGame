      ...
      <div className="row g-0 ">
        <div className="heroleft d-lg-block d-none col-lg-6 col-12 d-flex h-100">
          <div className="h-100 w-100" style={{ minHeight: "400px" }}>
            <div className="contentgps">
              <div className="gamepass">
                <img src={btngamepass} style={{height:'75px'}} className="btngps" />
                <span className="textgps">Voir l'astuce</span>
              </div>
            </div>
          </div>
        </div>
        <div className="col-lg-6 heroright col-12 d-flex h-100">
          <div className=" h-100 w-100" style={{ minHeight: "400px" }}></div>
        </div>
